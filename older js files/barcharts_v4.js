...
d3.json("18245_madrid.json").then(function (dataset) {
    ...
    var bar = svg2.selectAll("rect")
        ...
        .attr("y", 10) //where to start drawing blue box   .attr("y", 0) 
        .attr("width", xScale2.bandwidth())
        .attr("height", dimensions2.height - dimensions2.margin.bottom - dimensions2.margin.top) //        .attr("height", dimensions2.height - dimensions2.margin.bottom)
        .attr("fill", "steelblue")
        .attr("opacity", "0.1")
    ...
    function stat(button) {
        ...
        svg4.append('text')
            ...
            .attr("dx", 20)
            .attr("dy", 230)
            .text(function (d) { return ('GOALS : ' + d.goals) })
            .attr('font-size', "15px")
            .style("fill", "black")
        ...
        svg4.append('text')
            ...
            .attr("dx", 20)
            .attr("dy", 255)
            .text(function (d) { return ('ASSISTS : ' + d.assists) })
            .attr('font-size', "15px")
            .style("fill", "black")
        ...
        svg4.append('text')
            ...
            .attr("dx", 20)
            .attr("dy", 280)
            .text(function (d) { return ('SHOTS : ' + d.shots_taken) })
            .attr('font-size', "15px")
            .style("fill", "black")
        ...
        svg4.append("text")
            ...
            .data(stats.filter(d => d.id == button))
            //.attr("text-anchor", "middle")
            .attr("dx", function (d) { return x_passes_attempted(d.passes_attempted) })
            .attr("dy", 335)
            .text(function (d) { return (d.passes_attempted) })
            .attr("font-family", "sans-serif")
            .attr("font-size", "12px")
            .attr("fill", "black")
        ...
        svg4.append("text")
            ...
            .data(stats.filter(d => d.id == button))
            //.attr("text-anchor", "middle")
            .attr("dx", function (d) { return x_passes_completed(d.passes_completed) })
            .attr("dy", 385)
            .text(function (d) { return (d.passes_completed) })
            .attr("font-family", "sans-serif")
            .attr("font-size", "12px")
            .attr("fill", "black")
            .attr('transform', 'translate(25,0)')
        ...
        svg4.append("text")
            ...
            .data(stats.filter(d => d.id == button))
            //.attr("text-anchor", "middle")
            .attr("dx", function (d) { return x_passing_accuracy(d.passing_accuracy) })
            .attr("dy", 435)
            .text(function (d) { return (d.passing_accuracy) + '%' })
            .attr("font-family", "sans-serif")
            .attr("font-size", "12px")
            .attr("fill", "black")
            .attr('transform', 'translate(25,0)')
